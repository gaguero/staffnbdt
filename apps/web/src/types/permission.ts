...
export const COMMON_PERMISSIONS = {
  ...
  INVITE_USER: { resource: PERMISSION_RESOURCES.USER, action: PERMISSION_ACTIONS.CREATE, scope: PERMISSION_SCOPES.DEPARTMENT },
  MANAGE_USER_STATUS: { resource: PERMISSION_RESOURCES.USER, action: PERMISSION_ACTIONS.UPDATE, scope: PERMISSION_SCOPES.DEPARTMENT },
  
  // Organization management - temporarily using 'all' scope for testing
  CREATE_ORGANIZATION: { resource: PERMISSION_RESOURCES.ORGANIZATION, action: PERMISSION_ACTIONS.CREATE, scope: 'all' },
  VIEW_ORGANIZATIONS: { resource: PERMISSION_RESOURCES.ORGANIZATION, action: PERMISSION_ACTIONS.READ, scope: 'all' },
  EDIT_ORGANIZATION: { resource: PERMISSION_RESOURCES.ORGANIZATION, action: PERMISSION_ACTIONS.UPDATE, scope: 'all' },
  DELETE_ORGANIZATION: { resource: PERMISSION_RESOURCES.ORGANIZATION, action: PERMISSION_ACTIONS.DELETE, scope: 'all' },
  
  // Property management - temporarily using 'all' scope for testing
  CREATE_PROPERTY: { resource: PERMISSION_RESOURCES.PROPERTY, action: PERMISSION_ACTIONS.CREATE, scope: 'all' },
  VIEW_PROPERTIES: { resource: PERMISSION_RESOURCES.PROPERTY, action: PERMISSION_ACTIONS.READ, scope: 'all' },
  EDIT_PROPERTY: { resource: PERMISSION_RESOURCES.PROPERTY, action: PERMISSION_ACTIONS.UPDATE, scope: 'all' },
  DELETE_PROPERTY: { resource: PERMISSION_RESOURCES.PROPERTY, action: PERMISSION_ACTIONS.DELETE, scope: 'all' },
